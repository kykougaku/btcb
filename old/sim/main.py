...
hist["MFI"] = ta.MFI(hist["High"], hist["Low"], hist["Close"], hist["Volume"], timeperiod=14)
...
up = fig.add_subplot(4,1,1)
down = fig.add_subplot(4,1,2)
down1 = fig.add_subplot(4,1,3)
down2 = fig.add_subplot(4,1,4)
...
down1.plot(hist.index,hist["MFI"],color="green")
